...
class TTextThemes {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    labelMedium: TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.black.withValues(alpha: 0.6)),
  );
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    labelMedium: TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.white.withValues(alpha: 0.6)),
  );
}